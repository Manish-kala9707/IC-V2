        ...
        <div className="App">
          {location && !location?.pathname?.includes("title") && (
            <Container className="archive-header">
              <Row>
                <Col>
                  {location.pathname.includes("international-museum-expo") && (
                    <h1>International Museum Expo</h1>
                  )}
                  {location.pathname.includes("festival-of-libraries") && (
                    <h1>Festival of Libraries</h1>
                  )}
                  {location.pathname.includes(
                    "Indian-Art-Architecture-and-Design-Biennale"
                  ) && <h1>Indian Art Architecture and Design Biennale</h1>}
                  <img
                    src={Divider}
                    alt="Caption Divider"
                    style={{
...
export default InternationalMuseumExpo;
