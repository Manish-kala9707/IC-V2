    ...
    { !response.ok?(<ErrorPage />):( <div className="App">
        ...
        {location && !location?.pathname?.includes("title") &&
          <Container >
            ...
            <InternalSearchCard filterSearchdata={filterSearchdata}  filterSearchdata2={filterSearchdata2} filterSearchdata3={filterSearchdata3} filterName1={"Category"} filterName2={"State"} filterName3={"District"} category={"digital-district-repository/district-repository"}/>
