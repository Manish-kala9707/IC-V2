...
<Offcanvas show={show} onHide={handleClose} backdrop="true"  scroll="false">
      ...
      {location && !location.pathname.includes("title") && <Pagination2 totalPages={totalPages} baseUrl="/digital-district-repository/personalities" />}
    </div>
  );
};
export default DDRpersonalities;
