...
<Offcanvas show={show} onHide={handleClose} backdrop="true"  scroll="false">
      ...
      {location && !location.pathname.includes("title") && <Pagination2 totalPages={totalPages} baseUrl="/freedom-struggle/textile" />}
    </div>
  );
};
export default FreedomTextile;
