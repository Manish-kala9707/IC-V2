  ...
  return (
    ...
    { !response.ok?(<ErrorPage />):( <div className="App">
        {location && !location?.pathname?.includes("title") && <Container  className="archive-header">
          <Row>
            <Col>
              { location.pathname.includes("-read") && <h1>Rare material on {location.pathname.split("/")[2].replaceAll("%20"," ").replaceAll("-read","")}</h1>}
              { location.pathname.includes("-see") && <h1>Photo Archive on {location.pathname.split("/")[2].replaceAll("%20"," ").replaceAll("-see","")}</h1>}
              { location.pathname.includes("-glimpse") && <h1>Glimpses of {location.pathname.split("/")[2].replaceAll("%20"," ").replaceAll("-glimpse","")}</h1>}
        ...
        {location && !location?.pathname?.includes("title") &&
          <Container >
            <Row>
            <InternalSearchCard filterSearchdata={filterSearchdata} filterName1={"type"} category={"archives"}/>
