      ...
      {location && location?.pathname?.includes("title") ? (
        ...
        <Container ><Row>
          <div  className="page-content4"> 
            ...
            > <Card page="/" search_results={fetchedData} setDetailData={setDetailData} className="page-content4" /> 
            </Suspense>

          </div></Row>
        </Container>
      )}
      {location && !location.pathname.includes("title") && <Pagination2 totalPages={totalPages} baseUrl="food-and-culture/cuisines-of-india/culturalcuisine" />}
    </div>
  );
};
export default Cuisineculturalcuisine;
